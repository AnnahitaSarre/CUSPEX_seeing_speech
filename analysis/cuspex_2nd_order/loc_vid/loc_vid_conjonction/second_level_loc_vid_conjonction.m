...
for i_contrast=1:numel(contrasts_list)
    ...
    matlabbatch_second_level_loc_vid_conjonction_job = second_level_loc_vid_conjonction_job(subjects_list, group, smoothing_level, contrast, covariates);
    spm_jobman('run', matlabbatch_second_level_loc_vid_conjonction_job);
end