...
function matlabbatch = second_level_loc_stat_conjonction_job(subjects_list, group, smoothing_level, contrast, covariates)
   ...
   matlabbatch{1}.spm.stats.factorial_design.dir = {strcat('/mnt/ata-ST4000NM0165_ZAD8CWEG-part1/cuspex/cuspex_analysis/cuspex_2nd_order/loc_stat/loc_stat_conjonction/results_s', smoothing_level, '/', contrast_dir_name, '/', group)};

    contrast_file_num = contrast{2};

    scans1 = {};
    for subject=1:numel(subjects_list{1})
       scans1{subject} = sprintf('/mnt/ata-ST4000NM0165_ZAD8CWEG-part1/cuspex/cuspex_analysis/cuspex_final_images/CUSPEX_s%02d/func/loc_stat/stats/smoothed_%s/con_00%02d.nii,1', subjects_list{1}(subject), smoothing_level, contrast_file_num);
    end
    scans1 = scans1.';
    ...
    for subject=1:numel(subjects_list{2})
       scans2{subject} = sprintf('/mnt/ata-ST4000NM0165_ZAD8CWEG-part1/cuspex/cuspex_analysis/cuspex_final_images/CUSPEX_s%02d/func/loc_stat/stats/smoothed_%s/con_00%02d.nii,1', subjects_list{2}(subject), smoothing_level, contrast_file_num);
    end
    scans2 = scans2.';
    ...
    if numel(subjects_list) == 3
        ...
        for subject=1:numel(subjects_list{3})
           scans3{subject} = sprintf('/mnt/ata-ST4000NM0165_ZAD8CWEG-part1/cuspex/cuspex_analysis/cuspex_final_images/CUSPEX_s%02d/func/loc_stat/stats/smoothed_%s/con_00%02d.nii,1', subjects_list{3}(subject), smoothing_level, contrast_file_num);
        end
        scans3 = scans3.';
